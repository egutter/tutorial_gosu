class TextField < Gosu::TextInput
    ...
    def draw
      ...
      Gosu.draw_quad(x - PADDING,         y - PADDING,          background_color,
                        x + width + PADDING, y - PADDING,          background_color,
                        x - PADDING,         y + height + PADDING, background_color,
                        x + width + PADDING, y + height + PADDING, background_color, ZOrder::UI)
      ...
      Gosu.draw_quad(sel_x, y,          SELECTION_COLOR,
                        pos_x, y,          SELECTION_COLOR,
                        sel_x, y + height, SELECTION_COLOR,
                        pos_x, y + height, SELECTION_COLOR, ZOrder::UI)
  
      # Draw the caret; again, only if this is the currently selected field.
      if @window.text_input == self then
        Gosu.draw_line(pos_x, y,          CARET_COLOR,
                          pos_x, y + height, CARET_COLOR, ZOrder::UI)
      end
